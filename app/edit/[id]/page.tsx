export default function EditPage() {
    return(
         <div>
            <h2 className="text-2xl font-bold my-8">Edit Menu Item</h2>
            <form className="flex gap-4 flex-col">
                ...
                className="py-1 px-4 border rounder-md"
                />
                <button className="bg-black text-white rounded-md font-bold px-4 py-1 mt-3 uppercase cursor-pointer">Update Menu</button>
            </form>
        </div>
    );
}
